...
function DatePanel(props) {
  ...
  var getCellClassName = function getCellClassName(date) {
    var _classObj;
    var classObj = (_classObj = {}, (0, _defineProperty2.default)(_classObj, "".concat(prefixCls, "-cell-in-view"), (0, _dateUtil.isSameMonth)(generateConfig, date, pickerValue)), (0, _defineProperty2.default)(_classObj, "".concat(prefixCls, "-cell-today"), (0, _dateUtil.isSameDate)(generateConfig, date, now)), _classObj);
    return classObj;
  };
