  ...
  for (var row = 0; row < rowNum; row += 1) {
    ...
    var _loop = function _loop() {
      ...
      rowNode.push( /*#__PURE__*/React.createElement("td", {
        key: col,
        title: title,
        className: (0, _classnames.default)(cellPrefixCls, (0, _objectSpread3.default)((_objectSpread2 = {}, (0, _defineProperty2.default)(_objectSpread2, "".concat(cellPrefixCls, "-disabled"), disabled), (0, _defineProperty2.default)(_objectSpread2, "".concat(cellPrefixCls, "-hover"), (hoverValue || []).some(function (date) {
          return (0, _dateUtil.isSame)(generateConfig, locale, currentDate, date, type);
        })), (0, _defineProperty2.default)(_objectSpread2, "".concat(cellPrefixCls, "-in-range"), inRange && !rangeStart && !rangeEnd), (0, _defineProperty2.default)(_objectSpread2, "".concat(cellPrefixCls, "-range-start"), rangeStart), (0, _defineProperty2.default)(_objectSpread2, "".concat(cellPrefixCls, "-range-end"), rangeEnd), (0, _defineProperty2.default)(_objectSpread2, "".concat(prefixCls, "-cell-selected"), !hoverRangeValue &&
        // WeekPicker use row instead
        type !== 'week' && matchValues(currentDate)), _objectSpread2), getCellClassName(currentDate))),
