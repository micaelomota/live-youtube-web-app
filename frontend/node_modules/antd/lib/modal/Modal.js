...
const Modal = props => {
  ...
  const [mergedClosable, mergedCloseIcon] = (0, _useClosable.default)(closable, typeof closeIcon !== 'undefined' ? closeIcon : modal === null || modal === void 0 ? void 0 : modal.closeIcon, icon => (0, _shared.renderCloseIcon)(prefixCls, icon), /*#__PURE__*/React.createElement(_CloseOutlined.default, {
