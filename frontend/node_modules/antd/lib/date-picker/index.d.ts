...
declare const DatePicker: (<ValueType = Dayjs>(props: PickerPropsWithMultiple<Dayjs, PickerProps<Dayjs>, ValueType>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & {
    ...
    TimePicker: (<ValueType_2 = Dayjs>(props: PickerPropsWithMultiple<Dayjs, Omit<Omit<PickerProps<Dayjs>, "picker" | "showTime">, "picker">, ValueType_2>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & {
        displayName?: string | undefined;
    };
    QuarterPicker: (<ValueType_2 = Dayjs>(props: PickerPropsWithMultiple<Dayjs, Omit<Omit<PickerProps<Dayjs>, "picker" | "showTime">, "picker">, ValueType_2>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & {
        displayName?: string | undefined;
    };
};
